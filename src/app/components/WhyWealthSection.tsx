    ...
    <section className="px-5 py-18 md:px-[60px] lg:px-[200px]">
      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-3 lg:gap-8">
        {advantageCards.map((title) => (
          ...
          >
            <div className="rounded-[22px] bg-[linear-gradient(180deg,#6D88AA_0%,#5C7CA3_100%)] px-6 py-5 text-center text-2xl font-semibold tracking-[-0.04em] text-white shadow-[0_10px_24px_rgba(66,99,139,0.24)] sm:px-8 sm:py-6 sm:text-3xl">
              {title}
            </div>
            <div className="min-h-[160px] rounded-[22px] bg-transparent sm:min-h-[220px]" />
          </article>
        ))}
      </div>
    </section>
