...
export default function HeroSection() {
  ...
  return (
    <section className="px-5 pb-16 pt-10 md:px-[60px] md:pb-20 lg:px-[200px] lg:pt-14">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {goals.map((goal) => (
              ...
              >
                ...
                <span className="text-2xl font-medium text-[#2E5D95]">{goal.title}</span>
              </article>
            ))}
          </div>
        </div>
        ...
        <div className="relative flex min-h-[640px] items-start justify-center pt-6 lg:min-h-[720px]">
          <div className="relative z-10 w-full max-w-[640px] rounded-[44px] border border-[#7CAFEA] bg-[linear-gradient(180deg,#CCE5F7_0%,#D9ECFB_100%)] p-6 shadow-[0_24px_80px_rgba(73,136,219,0.50)] md:p-10">
            <div className="rounded-[36px] bg-white/35 p-6 md:p-8">
              <h3 className="text-center text-3xl font-semibold text-[var(--color-primary)]">Buy a car</h3>
              <div className="mt-8 grid gap-8 md:grid-cols-[minmax(0,1fr)_220px]">
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="w-full rounded-[22px] border border-[#6DA4E8] bg-white/92 px-6 py-6 text-center shadow-[0_12px_30px_rgba(64,124,201,0.18)]">
                    ...
                    <p className="mt-3 text-4xl font-semibold text-[var(--color-primary)]">₹ 11.3L</p>
                  </div>
                  <span className="text-lg text-[var(--color-primary)]/55">OR</span>
                  <div className="w-full rounded-[22px] border border-[#6DA4E8] bg-white/92 px-6 py-6 text-center shadow-[0_12px_30px_rgba(64,124,201,0.18)]">
                    <p className="text-lg text-[var(--color-primary)]/70">Monthly SIP</p>
                    <p className="mt-3 text-4xl font-semibold text-[var(--color-primary)]">₹ 24k</p>
                  </div>
                </div>
              </div>
            </div>
